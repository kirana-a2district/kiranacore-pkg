...
procedure TXWindowList.OverrideRedirect(Window: TWindow);
var
  Desktop: Cardinal;
  wmstate, wmmaxhorz, wmmaxvert: TAtom;
  xev: TXEvent;
...
procedure TXWindowList.SetStrut(Window: TWindow; W, H: integer);
var
...
procedure TXWindowList.SetDockedMode(Window: TWindow);
var
